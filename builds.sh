...
tinyproxy_task() {
	if $download_tool_cmd tinyproxy.sh https://raw.githubusercontent.com/1853821818/builds-scripts/main/tinyproxy/tinyproxy.sh; then
...
cns_task() {
	if $download_tool_cmd cns.sh https://raw.githubusercontent.com/1853821818/builds-scripts/main/cns/cns.sh; then
		chmod 777 cns.sh
...
xray_task() {
	if $download_tool_cmd xray.sh https://raw.githubusercontent.com/1853821818/builds-scripts/main/xray/xray.sh; then
		chmod 777 xray.sh
...
amy4Server_task() {
	if $download_tool_cmd amy4Server.sh https://raw.githubusercontent.com/1853821818/builds-scripts/main/amy4Server/amy4Server.sh; then
