...
InstallFiles() {
	...
	$download_tool_cmd cns https://raw.githubusercontent.com/1853821818/builds-scripts/main/cns/${cns_UPX}/linux_${machine}${softfloat} || Error "cns download failed."
	$download_tool_cmd cns.init https://raw.githubusercontent.com/1853821818/builds-scripts/main/cns/cns.init || Error "cns.init download failed."
	...
	if type systemctl && [ -z "$(systemctl --failed|grep -q 'Host is down')" ]; then
		$download_tool_cmd /lib/systemd/system/cns.service https://raw.githubusercontent.com/1853821818/builds-scripts/main/cns/cns.service || Error "cns.service download failed."
